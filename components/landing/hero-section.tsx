...
export default function HeroSection({ activeTab, visitedTabs }: HeroSectionProps) {
  return (
    <section className="flex flex-col items-center pt-2 pb-6 text-center md:pt-3 md:pb-6 lg:items-start lg:pt-2 lg:pb-0 lg:text-left xl:pt-3 min-[1440px]:pt-4 min-[1440px]:pb-3 min-[2200px]:pt-7 min-[2200px]:pb-5">
      ...
      >
        <span className="inline-block animate-role-card-float">
      ...
      <Link
        href="/e8/quiz"
        className="motion-fade-up group relative flex w-full max-w-[320px] items-center justify-center gap-2 rounded-2xl bg-indigo-600 py-3.5 text-sm font-bold text-white shadow-lg shadow-indigo-900/40 transition-all duration-200 ease-out hover:-translate-y-1 hover:brightness-110 hover:shadow-indigo-500/50 active:scale-[0.985] motion-reduce:transform-none sm:w-auto sm:min-w-[230px] sm:max-w-none md:min-w-[248px] min-[1440px]:min-w-[288px] min-[1440px]:rounded-3xl min-[1440px]:py-4 min-[1440px]:text-base min-[2200px]:min-w-[332px] min-[2200px]:py-[1.1rem] min-[2200px]:text-[1.08rem]"
        style={{ animationDelay: "190ms", animationDuration: "420ms" }}
      >
        Zacznij test
        <ChevronRight
          size={20}
          className="text-indigo-200 transition-transform"
        />
      </Link>
